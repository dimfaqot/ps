        ...
        if ($dbr->insert($datar)) {
            ...
            if ($q["durasi"] == 0) {
                ...
                if (!$dbu->update($user)) {
                    ...
                    message($q['kategori'], $user['nama'] . " sukses bertansaksi " . rupiah($biaya), 200, "Saldo " . rupiah($sal));
            ...
            if ($dbr->update($qr)) {
                ...
                if ($dbu->update($user)) {
                    ...
                    if ($dbu->update($qu)) {
                        ...
                        clear_tabel('booking');
                        message($q['kategori'], $user['nama'] . " sukses bertransaksi sebesar " . rupiah($q['harga']), "200", "Saldo: " . rupiah($sisa));
