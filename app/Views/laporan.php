...
<body>
    ...
    <?php if ($unit == "barber"): ?>
        ...
        8. -2.745.545
        -->
        <?php $laba = [15941125, 5483634, -5973263, 5825116, 15562777, 2091393, 2057653, -2745545]; ?>
        ...
        <?php if ($order == ""): ?>
            ...
            <table style="margin-top: 10px;width:100%;">
                ...
                <?php $total = 0; ?>
                <?php foreach ($data['data'][$unit]['masuk'] as $k => $i): ?>
