...
<div class="container">
    ...
    <div class="d-flex gap-1">
        <div>
            <input class="input btn_cari_barang add_barang" data-target="add_barang" type="text" placeholder="Barang" readonly>
        </div>
    </div>
            ...
            post('js/select_barang', {
                ...
                if (res.status == '200') {
                    ...
                    if (res.data.length == 0) {
                        ...
                        res.data.forEach(e => {
                            html += '<div ' + get_key_value_obj(e, 'autofill').join(" ") + ' class="div_list select_list_barang">' + e.barang + '</div>';
                        })
