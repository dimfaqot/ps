<script>
    ...
    data_ps.forEach((e, i) => {
        ...
        html_ps += '<div class="text-center div_durasi_' + e.meja + '" style="font-size:9px;margin-top:-5px">' + e.status + '</div>';
        html_ps += '</div>';
        if (i % 4 == 3) {
            html_ps += '</div>';
        }
    ...
    data_billiard.forEach((e, i) => {
        ...
        html_billiard += '<div class="text-center div_durasi_' + e.meja + '" style="font-size:9px;margin-top:-5px">' + e.status + '</div>';
        html_billiard += '</div>';
        if (i % 4 == 3) {
            html_billiard += '</div>';
        }
    ...
    const durasi_member = `<h6 class="text-center text-light mb-">DURASI (JAM)</h6>
    ...
    const menus = {
        ...
        topup: `<div class="rounded px-4">
                    ...
                    <div class="rounded-circle border border-secondary border-opacity-50 text-center px-3 fw-bold btn_sub_menu" data-sub_menu="3" style="padding-top:12px;cursor:pointer;font-size:x-large;width: 55px;height:55px;color:#cbf4f0;border:1px solid #242b32">3</div>
                    </div>
                    <div class="d-flex justify-content-center gap-5 mb-3">
                    <div class="rounded-circle border border-secondary border-opacity-50 text-center px-3 fw-bold btn_sub_menu" data-sub_menu="4" style="padding-top:12px;cursor:pointer;font-size:x-large;width: 55px;height:55px;color:#cbf4f0;border:1px solid #242b32">4</div>
                    <div class="rounded-circle border border-secondary border-opacity-50 text-center px-3 mx-2 fw-bold btn_sub_menu" data-sub_menu="5" style="padding-top:12px;cursor:pointer;font-size:x-large;width: 55px;height:55px;color:#cbf4f0;border:1px solid #242b32">5</div>
                    <div class="rounded-circle border border-secondary border-opacity-50 text-center px-3 fw-bold btn_sub_menu" data-sub_menu="6" style="padding-top:12px;cursor:pointer;font-size:x-large;width: 55px;height:55px;color:#cbf4f0;border:1px solid #242b32">6</div>
                    </div>
                    <div class="d-flex justify-content-center gap-5 mb-3">
                    <div class="rounded-circle border border-secondary border-opacity-50 text-center px-3 fw-bold btn_sub_menu" data-sub_menu="10" style="padding-top:12px;cursor:pointer;font-size:x-large;width: 55px;height:55px;color:#cbf4f0;border:1px solid #242b32">10</div>
                    <div class="rounded-circle border border-secondary border-opacity-50 text-center px-3 mx-2 fw-bold btn_sub_menu" data-sub_menu="20" style="padding-top:12px;cursor:pointer;font-size:x-large;width: 55px;height:55px;color:#cbf4f0;border:1px solid #242b32">20</div>
                    <div class="rounded-circle border border-secondary border-opacity-50 text-center px-3 fw-bold btn_sub_menu" data-sub_menu="30" style="padding-top:12px;cursor:pointer;font-size:x-large;width: 55px;height:55px;color:#cbf4f0;border:1px solid #242b32">30</div>
                    </div>
                    </div>`,
