    ...
    <div class="modal fade bg-dark" id="data_hutang" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
        ...
        <script>
            ...
            data_ps.forEach((e, i) => {
                ...
                html_ps += '<div class="text-center" style="font-size:9px;margin-bottom:-13px">MEJA</div>' + e.meja;
            ...
            data_billiard.forEach((e, i) => {
                ...
                html_billiard += '<div class="text-center" style="font-size:9px;margin-bottom:-13px">MEJA</div>' + e.meja;
            ...
            const menus = {
                ...
                topup: `<div class="rounded px-4 pt-4">
                    ...
                    <div class="rounded-circle embos text-center p-2 fw-bold btn_durasi" data-durasi="2" style="cursor:pointer;font-size:x-large;width: 55px;height:55px;color:#cbf4f0;border:1px solid #242b32">2</div>
                    ...
                    <div class="rounded-circle embos text-center p-2 fw-bold btn_durasi" data-durasi="5" style="cursor:pointer;font-size:x-large;width: 55px;height:55px;color:#cbf4f0;border:1px solid #242b32">5</div>
                    ...
                    <div class="rounded-circle embos text-center p-2 fw-bold btn_durasi" data-durasi="20" style="cursor:pointer;font-size:x-large;width: 55px;height:55px;color:#cbf4f0;border:1px solid #242b32">20</div>
                ...
                durasi: `<div class="rounded px-4 pt-4 mt-2">
                    ...
                    <div class="rounded-circle embos text-center p-2 fw-bold btn_durasi" data-durasi="8" style="cursor:pointer;font-size:x-large;width: 55px;height:55px;color:#cbf4f0;border:1px solid #242b32">8</div>
