    ...
    <div class="modal fade bg-dark" id="data_hutang" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
        ...
        <script>
            ...
            data_ps.forEach((e, i) => {
                ...
                html_ps += '<div class="text-center" style="font-size:9px;margin-bottom:-8px">MEJA</div>' + e.meja;
            ...
            data_billiard.forEach((e, i) => {
                ...
                html_billiard += '<div class="text-center" style="font-size:9px;margin-bottom:-8px">MEJA</div>' + e.meja;
